document.addEventListener("DOMContentLoaded", function () {
  ...
  const sectionFilters = [{ keywords: ["chm101",'chemistry','james'], containerIds: ["chm101"] }];
